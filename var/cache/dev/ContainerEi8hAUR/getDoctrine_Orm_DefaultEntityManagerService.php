...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\LogFileOffsetRepository' => ['privates', 'App\\Repository\\LogFileOffsetRepository', 'getLogFileOffsetRepositoryService', true],
            'App\\Repository\\ServiceLogRepository' => ['privates', 'App\\Repository\\ServiceLogRepository', 'getServiceLogRepositoryService', true],
        ], [
            'App\\Repository\\LogFileOffsetRepository' => '?',
            'App\\Repository\\ServiceLogRepository' => '?',
        ])));
