 ...
 */
class getServiceLogRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ServiceLogRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceLogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceLogRepository.php';

        return $container->privates['App\\Repository\\ServiceLogRepository'] = new \App\Repository\ServiceLogRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
