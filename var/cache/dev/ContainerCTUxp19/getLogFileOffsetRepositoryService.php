 ...
 */
class getLogFileOffsetRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LogFileOffsetRepository' shared autowired service.
     *
     * @return \App\Repository\LogFileOffsetRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LogFileOffsetRepository.php';

        return $container->privates['App\\Repository\\LogFileOffsetRepository'] = new \App\Repository\LogFileOffsetRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
